...
# Configuration
REPO_URL_SSH="${HERMES_REPO_URL_SSH:-git@github.com:northmendo/hermes-agent.git}"
REPO_URL_HTTPS="${HERMES_REPO_URL_HTTPS:-https://github.com/northmendo/hermes-agent.git}"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/northmendo/hermes-agent/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
