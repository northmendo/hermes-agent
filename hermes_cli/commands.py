...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("fusion", "Configure OpenRouter Fusion router settings", "Configuration",
               args_hint="[status|on|off|show|hide|preset|models|judge|max-tool-calls]",
               subcommands=("status", "on", "off", "show", "hide", "preset", "models", "judge", "max-tool-calls")),
